...
ClientBookPC 是 `CodeBookChat` 的PC端桌面版本，可以在不利用或没有浏览的情况下使用 `CodeBookChat` 进行聊天与通讯。
...
请您 [点击这里下载](https://github.com/BeardedManZhao/ClientBookPC/releases/download/1.1/ClientBook-PC.zip) Windows和Linux的通用版本！
